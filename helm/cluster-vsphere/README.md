...
| `global.controlPlane.machineTemplate.resourcePool` | **Resource pool name**|**Type:** `string`<br/>**Default:** `"*/Resources"`|
...
| `global.nodeClasses.default.resourcePool` | **Resource pool name**|**Type:** `string`<br/>**Default:** `"*/Resources"`|
