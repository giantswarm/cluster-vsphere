...
| `global.controlPlane.machineTemplate.cloneMode` | **VM template clone mode**|**Type:** `string`<br/>**Allowed values:** `fullClone`, `linkedClone`<br/>**Default:** `"linkedClone"`|
...
| `global.nodePools.worker.cloneMode` | **VM template clone mode**|**Type:** `string`<br/>**Allowed values:** `fullClone`, `linkedClone`<br/>**Default:** `"linkedClone"`|
...
| `global.providerSpecific.defaultStorageClass.reclaimPolicy` | **Reclaim Policy** - Reclaim policy of the storage class (Delete or Retain).|**Type:** `string`<br/>**Allowed values:** `Delete`, `Retain`<br/>**Default:** `"Delete"`|
